        ...
        await pool
            .task(async (consulta) => {
                ...
                if(!objCaso.codCasoPadre){
                    ...
                    objCaso.fechaInicio, objCaso.cliente, objCaso.firma, objCaso.codSubtipoCaso, 1]);
                } else {
                    obj = await consulta.one(SQL_CASOS.ADD, [objCaso.titulo, objCaso.descripcion, objCaso.estado, 
                    objCaso.fechaInicio, objCaso.cliente, objCaso.firma, objCaso.codSubtipoCaso, objCaso.codCasoPadre]);
                }
