...
import controllerFindFilterCaso from "../controller/ControllerFindFilterCaso";
...
class RouteCaso {
    ...
    constructor() {
        ...
        this.routeCasoApi.post("/getfilter", verificarToken, controllerFindFilterCaso.callFindFilter);
